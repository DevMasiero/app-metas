...
const listarMetas = async () => {
    ...
    const respostas = await checkbox({
        message: "Use as setas para mudar de meta, o espaço para marcar e desmarcar e o Enter para finalizar a etapa",
        choices: [...metas],
        instructions: false,
...
const metasAbertas = async () => {
    ...
    await select({
        message: "Voce possui" + ' ' + abertas.length + ' ' + "metas abertar",
        choices: [...abertas]
    })
}
